...
public enum MessageResponseEnum {
    ...
    OVERCOMING_BURN_OUT_SYNDROME_MESSAGE("/overcoming", """
            ...
            Ти можеш переглянути відео чудового спеціаліста за посиланням https://youtu.be/EORBcoDf4Vo
    ...
    Пропоную, щоб визначити рівень твоєї тривожності пройти тестування за посиланням 
    ...
    Проте слід розуміти, що це тільки симптоматична терапія. І проблему потрібно вирішувати глибше, тому звернися до фахівця.
